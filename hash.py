...
#must line after argparse
if args.hash:
    hashvalue = args.hash
    print(f"{green}[+] MD5     : {hashlib.md5(hashvalue.encode()).hexdigest()}")
    print(f"{green}[+] SHA1    : {hashlib.sha1(hashvalue.encode()).hexdigest()}")
    print(f"{green}[+] SHA256  : {hashlib.sha256(hashvalue.encode()).hexdigest()}")
    print(f"{green}[+] SHA384  : {hashlib.sha384(hashvalue.encode()).hexdigest()}")
    print(f"{green}[+] SHA512  : {hashlib.sha512(hashvalue.encode()).hexdigest()}")
    exit()  
